        ...
        <div className="min-h-screen bg-gray-50 py-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="bg-white rounded-xl overflow-hidden shadow-md">
                        <div className="flex flex-col md:flex-row">
                            ...
                            <div className="w-full md:w-1/2 p-4 sm:p-6 md:p-8">
                                <h2 className="text-2xl sm:text-3xl font-bold mb-4">מנדפים מעוצבים ושקטים לבתי קפה</h2>
                ...
                <section className="mb-16">
                    <h2 className="text-2xl sm:text-3xl font-bold text-center mb-6 sm:mb-10">מאפיינים מיוחדים למנדפים לבתי קפה</h2>
