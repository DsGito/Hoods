      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="col-span-1">
            <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">עקבו אחרינו</h3>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">קישורים מהירים</h3>
          ...
          <div className="md:col-span-2 lg:col-span-1">
            <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">יצירת קשר</h3>
        ...
        <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-gray-700 text-center text-gray-400">
          <p className="text-xs sm:text-sm">
            &copy; {new Date().getFullYear()} כל הזכויות שמורות | טי אמ מנדפים - T.M mindafim
          </p>
